...
function feedAll(parser: SMTPParser, chunks: Buffer[]): string[] {
  const lines: string[] = [];
...
function collectDataMode(parser: SMTPParser, chunks: Buffer[], maxBytes = 0): Promise<DataResult> {
